                        ...
                        {availableTags.filter(tag => !newNoteTags.some(t => t.name === tag) && tag.includes(newNoteTagInput)).map(tag => {
                          ...
                          return (
                            <div
                              key={tag}
                              onClick={() => {
                                setNewNoteTags([...newNoteTags, { name: tag, color: color.border === '#cccccc' ? 'gray' : color.name }])
                                setNewNoteTagInput('')
                        ...
                        {availableTags.filter(tag => !editNoteTags.some(t => t.name === tag) && tag.includes(editNoteTagInput)).map(tag => {
                          ...
                          return (
                            <div
                              key={tag}
                              onClick={() => {
                                setEditNoteTags([...editNoteTags, { name: tag, color: color.border === '#cccccc' ? 'gray' : color.name }])
                                setEditNoteTagInput('')
